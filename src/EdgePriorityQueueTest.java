...
public class EdgePriorityQueueTest {
    ...
    public void testIsEmpty01(){
        EdgePriorityQueue epq2 = new EdgePriorityQueue();
        Assert.assertTrue(epq2.isEmpty());
    }
    ...
    public void testDecrease01(){
        EdgePriorityQueue epq2 = new EdgePriorityQueue();
        epq2.add(edges.get(3));
        epq2.decrease(3, 3, 1);
        String example = "3(3, 1) ";
        Assert.assertEquals(example, epq2.toString());
    }
